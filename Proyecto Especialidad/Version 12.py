...
def mover_gato():
    ...
    if caso_actual < len(posiciones):

        destino = posiciones[caso_actual]

        posicion_actual = canvas.coords(gato)[0]

        animar_gato(posicion_actual, destino)

def animar_gato(actual, destino):
    ...
    if actual < destino:
        ...
        ventana_juego.after(
            20,
            lambda: animar_gato(actual, destino)
        )
...
def comenzar_juego():
    ...
    "Hola " + nombre +
    ".\n\nSoy Alex el gato.\n\n"
    "Necesito tu ayuda para resolver casos "
    "relacionados con problemas sociales.\n\n"
    "Cada respuesta correcta me acercará a la salida.\n\n"
    "Dispones de 5 vidas ❤️."
)
...
canvas.create_text(100,40,text="🚪",font=("Arial",30))
canvas.create_text(220,40,text="🚪",font=("Arial",30))
canvas.create_text(340,40,text="🚪",font=("Arial",30))
canvas.create_text(460,40,text="🚪",font=("Arial",30))
canvas.create_text(580,40,text="🚪",font=("Arial",30))

gato = canvas.create_text(
    100,
    90,
    text="🐱",
    font=("Arial",25)
